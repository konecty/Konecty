...
export default app => {
	/* @CEP_List */
	// Converted to method
	app.get('/api/v1/dne/cep/:cep', async (req, res) => {
	...
	/* @City_List */
	// Converted to method
	app.get('/api/v1/dne/BRA/:state/:city', async (req, res) => {
	...
	/* @District_List */
	// Converted to method
	app.get('/api/v1/dne/BRA/:state/:city/:district', async (req, res) => {
	...
	/* @Place_List */
	// Converted to method
	app.get('/api/v1/dne/BRA/:state/:city/:district/:place/:number?/:limit?', async (req, res) => {
